...
<div class="container-repeatable-elements">
    <div
        ...
        data-subfield-names="<?php echo e(json_encode($subfieldNames)); ?>"

    >
    <?php if(!empty($field['value'])): ?>
        <?php $__currentLoopData = $field['value']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo $__env->make($crud->getFirstFieldView('inc.repeatable_row'), ['repeatable_row_key' => $key], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<button type="button" class="btn btn-outline-primary btn-sm ml-1 mt-2 add-repeatable-element-button">+ <?php echo e($field['new_item_label'] ?? trans('backpack::crud.new_item')); ?></button>

<?php echo $__env->make('crud::fields.inc.wrapper_end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->startPush('crud_fields_scripts'); ?>
    <?php echo $__env->make($crud->getFirstFieldView('inc.repeatable_row'), ['hidden' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>
  ...
  <?php $__env->startPush('crud_fields_styles'); ?>
      <?php $bassetBlock = 'backpack/pro/fields/repeatable-field.css'; ob_start(); ?>
      <style type="text/css">
        .repeatable-element {
  ...
  <?php $__env->startPush('crud_fields_scripts'); ?>
      <?php $bassetBlock = 'backpack/pro/fields/repeatable-field.js'; ob_start(); ?>
      <script>
        /**
    ...
    <?php Basset::bassetBlock($bassetBlock, ob_get_clean()); ?>
  <?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\instantscripts-new\vendor\backpack\pro/resources/views/fields/repeatable.blade.php ENDPATH**/ ?>