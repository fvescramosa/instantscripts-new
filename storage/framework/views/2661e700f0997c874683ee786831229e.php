...
<div class="col-md-12 well repeatable-element row m-1 p-2" data-repeatable-identifier="<?php echo e($field['name']); ?>">
    <?php if(isset($field['subfields']) && is_array($field['subfields']) && count($field['subfields'])): ?>
    <div class="controls">
        <button type="button" class="close delete-element"><span aria-hidden="true">×</span></button>
        <?php if($field['reorder']): ?>
    ...
    <?php $__currentLoopData = $field['subfields']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subfield): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <?php echo $__env->make($subfieldView, ['field' => $subfield, 'rowValues' => $rowValues ?? []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php unset($rowValues); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\instantscripts-new\vendor\backpack\pro/resources/views/fields/inc/repeatable_row.blade.php ENDPATH**/ ?>