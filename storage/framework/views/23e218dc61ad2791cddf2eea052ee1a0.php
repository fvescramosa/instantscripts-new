...
<?php echo $__env->make('crud::fields.inc.wrapper_start', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <input type="hidden" class="form-control" bp-field-main-input name="<?php echo e($field['name']); ?>" value="<?php echo e($field['value']); ?>">
...
<?php $__env->startPush('crud_fields_styles'); ?>
    <?php Basset::basset('https://unpkg.com/bootstrap-datepicker@1.9.0/dist/css/bootstrap-datepicker3.min.css'); ?>
<?php $__env->stopPush(); ?>


<?php $__env->startPush('crud_fields_scripts'); ?>
    <?php Basset::basset('https://unpkg.com/bootstrap-datepicker@1.9.0/dist/js/bootstrap-datepicker.min.js'); ?>
    <?php if($field['date_picker_options']['language'] !== 'en'): ?>
        <?php Basset::basset('https://unpkg.com/bootstrap-datepicker@1.9.0/dist/locales/bootstrap-datepicker.'.$field['date_picker_options']['language'].'.min.js'); ?>
    <?php endif; ?>

    <?php $bassetBlock = 'backpack/pro/fields/date-picker-field.js'; ob_start(); ?>
    <script>
        if (jQuery.ui) {
...
<?php /**PATH C:\laragon\www\instantscripts-new\vendor\backpack\pro/resources/views/fields/date_picker.blade.php ENDPATH**/ ?>