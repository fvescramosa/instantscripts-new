...
<?php echo $__env->make('crud::fields.inc.wrapper_start', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php if($activeInlineCreate): ?>
            <?php echo $__env->make($crud->getFirstFieldView('relationship.inc.inline_create_button'), ['field' => $field], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        ...
        <select
            ...
            data-original-name="<?php echo e($field['name']); ?>"
            style="width: 100%"
            data-force-select="<?php echo e(var_export($field['inline_create']['force_select'])); ?>"
            data-init-function="bpFieldInitFetchOrCreateElement"
            data-allows-null="<?php echo e(var_export($field['allows_null'])); ?>"
            ...
            data-field-ajax="<?php echo e(var_export($field['ajax'])); ?>"
            data-inline-modal-class="<?php echo e($field['inline_create']['modal_class']); ?>"
            data-app-current-lang="<?php echo e(app()->getLocale()); ?>"
            data-include-main-form-fields="<?php echo e(is_bool($field['inline_create']['include_main_form_fields']) ? var_export($field['inline_create']['include_main_form_fields']) : $field['inline_create']['include_main_form_fields']); ?>"
            data-ajax-delay="<?php echo e($field['delay']); ?>"
            data-language="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>"
            data-debug="<?php echo e(config('app.debug')); ?>"
            ...
            data-parent-loaded-fields=<?php echo e(json_encode(Basset::loaded())); ?>
    ...
    <?php $bassetBlock = 'backpack/pro/fields/relationship-fetch-or-create-field-'.app()->getLocale().'.js'; ob_start(); ?>
    <script>
    ...
    function triggerModal(element) {
        ...
        $modalSaveButton.on('click', function () {
            ...
            var loadingText = '<i class="la la-spinner la-spin"></i><?php echo e(trans('backpack::crud.inline_saving')); ?>';
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    new Noty({
                        type: "info",
                        text: '<?php echo e(trans('backpack::crud.related_entry_created_success')); ?>',
                    }).show();
                },
                error: function (result) {
                    ...
                    new Noty({
                        type: "error",
                        text: '<strong><?php echo e(trans('backpack::crud.related_entry_created_error')); ?></strong><br> '+message,
                    }).show();
...
<?php /**PATH C:\laragon\www\instantscripts-new\vendor\backpack\pro/resources/views/fields/relationship/fetch_or_create.blade.php ENDPATH**/ ?>