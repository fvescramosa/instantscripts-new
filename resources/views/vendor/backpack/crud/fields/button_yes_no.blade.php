...
@push('crud_fields_styles')
    ...
    @basset('button_yes_noFieldStyle.css')

    {{-- How to add some CSS? --}}
    @bassetBlock('backpack/crud/fields/button_yes_no_field-style.css')
        <style>
            .button_yes_no_field_class {
                display: none;
            }
        </style>
    @endBassetBlock
...
@push('crud_fields_scripts')
    ...
    @basset('button_yes_noFieldScript.js')
